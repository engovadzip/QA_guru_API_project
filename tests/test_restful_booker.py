...
class TestBooking:
    ...
    def test_get_booking_info(self, base_url):
        ...
        with allure.step(f"Получение информации о бронировании {booking_id}"):
            response = api_method.get_booking_info(base_url, booking_id)
    ...
    def test_update_booking_info(self, base_url, booking_info, user_name, password):
        ...
        with allure.step(f"Обновление информации в бронировании {booking_id}"):
            update_response = api_method.update_booking(base_url, booking_id, booking_info, token)
        ...
        with allure.step("Получение информации об обновленном бронировании"):
            upd_response = api_method.get_booking_info(base_url, booking_id)
    ...
    def test_create_booking(self, base_url, booking_info):
        with allure.step("Отправка запроса с данными о новом бронировании"):
            response = api_method.create_booking(base_url, booking_info)
    ...
    def test_delete_booking(self, base_url, user_name, password):
        with allure.step("Получение токена для возможности редактирования бронирования"):
            token = get_token(base_url, user_name, password)
        ...
        with allure.step(f"Удаление бронирования {booking_id}"):
            delete_response = api_method.delete_booking(base_url, booking_id, token)
