...
from tests.conftest import booking_url


class APIMethods:
    def get_bookings(self, base_url):
    ...
    def get_booking_info(self, base_url, booking_id):
    ...
    def update_booking(self, base_url, booking_id, booking_info, token):
    ...
    def create_booking(self, base_url, booking_info):
    ...
    def delete_booking(self, base_url, booking_id, token):
